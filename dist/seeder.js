...
connectDB();
var bootcamps = JSON.parse(fs_1.default.readFileSync(__dirname + "/_data/bootcamps.json", "utf-8"));
var courses = JSON.parse(fs_1.default.readFileSync(__dirname + "/_data/courses.json", "utf-8"));
var users = JSON.parse(fs_1.default.readFileSync(__dirname + "/_data/users.json", "utf-8"));
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, Course_1.default.deleteMany()];
                case 2:
                    _a.sent();
