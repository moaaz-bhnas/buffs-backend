...
schema.statics.getAverageCost = function (bootcampId) {
    return __awaiter(this, void 0, void 0, function () {
        var averageCostObject, bootcampModel, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    averageCostObject = _a.sent();
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    bootcampModel = this.prototype.model("Bootcamp");
                    return [4 /*yield*/, bootcampModel.findByIdAndUpdate(bootcampId, {
...
var CourseModel = (0, mongoose_1.model)("Course", schema);
